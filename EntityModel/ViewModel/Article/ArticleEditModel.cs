...
namespace ViewModels
{
    public class ArticleEditModel
    {
        ...
        public bool IsShowMoreArticle { get; set; }
        public string GroupItemList { get; set; }
        public bool IsNew { get; set; }
        public string StDateNewStr { get; set; }
        public string EdDateNewStr { get; set; }
        public string GroupNameListStr { get; set; }
        public string ExtItemList { get; set; }
        public string ExtItemObj { get; set; }
        public string ExtLiList { get; set; }
    }

    public class ExtItemObj{
